    ...
    en: {
      translation: {
        ...
        about: {
          ...
          title: 'TitleTraveling Website for you',
          subTitle1: 'Discover breathtaking destinations around the world.',
          subTitle2: 'Plan your perfect getaway with ease and confidence.',
          subTitle3: 'Exclusive deals and expert tips for every traveler.',
          subTitle4: 'Your journey starts here — let’s explore together.',
          startButton: 'Start',
          warningVirtual: 'Start your journey without leaving home',
          aboutVirtual:
            'Our virtual tours let you explore top destinations online before you visit.',

          virtualText1: 'Get a 360° preview of iconic places worldwide.',
          virtualText2:
            'Experience the vibe, culture, and scenery from your screen.',

          hlrSearch: 'Smart Destination Finder',
          hlrText:
            'Not sure where to go? Use our smart search to discover places that match your vibe and budget.',

          osnoviApi: 'Travel API Integration',
          osnoviApiText:
            'Seamlessly connect with airlines, hotels, and local experiences using our powerful travel APIs.',

          tochniTitle: 'Accurate & Real-Time Data',
          tochniText:
            'From flight updates to weather conditions — we provide up-to-the-minute travel information.',

          oxvachen: 'Global Coverage',
          oxvachenText:
            'From major cities to hidden gems — our platform helps you explore it all, anywhere in the world.',
        },
        faq: {
          title: 'FAQ',
          faqText:
            'Find answers to common questions about bookings, payments, and travel tips.',
          sotrudichayte:
            'Interested in partnering with us? Check out how we collaborate with travel agencies and influencers.',
        },

        contactUs: {
          sotrudichayte: 'Let’s work together to make travel better.',
          name: 'First Name',
          lastName: 'Last Name',
          ...
          requiredMessage: 'Please write a message before sending.',
          success:
            'Your message has been sent successfully! We’ll get back to you soon.',
        },

        bookComponent: {
          bigTitle: 'Learn more by asking the smart AI tool',
          askQuestion: 'Ask Question',
          enterText: 'Enter text',
          askMe: 'Ask me anything about traveling...',
        },
        mainAbout: {
          title: 'About us',
          whyWe: 'Why WE?',
          howOrder: 'How to order journey ?',
          why1: '1. Expertise You Can Trust We’ve gathered a team of seasoned travelers, local experts, and industry professionals who provide you with the most accurate, up-to-date travel information. We go beyond typical tourist guides, offering insights from those who have truly experienced the destinations firsthand.',
          why2: '2.Tailored Travel Plans Every traveler is unique, and so are their needs. Our platform lets you create a customized itinerary based on your interests, whether youre looking for relaxation, adventure, culture, or food. With our expert recommendations, youll be able to craft the perfect trip that suits your style and pace.',
          why3: '3.Seamless Booking Experience From booking flights to securing your accommodation and planning activities, our integrated system allows you to do it all in one place. We partner with trusted providers to ensure you have access to the best deals, saving you both time and money',
          why4: '4.  Authentic Local Experiences We focus on providing recommendations that give you a true sense of the local culture. Whether it’s discovering hidden gems, eating at local restaurants, or exploring off-the-beaten-path attractions, our goal is to help you experience destinations like a local.',
          how1: 'Planning a trip can sometimes feel overwhelming, but with the right approach, it can be an exciting and seamless experience. Whether youre heading to a far-off destination or exploring nearby spots, organizing your journey step by step is key to ensuring you have an unforgettable time. Heres how you can order your journey from start to finish.',
          how2: 'The first step is deciding where you want to go. Consider factors like the climate, activities, budget, and the duration of your trip. Do you want a beach vacation, a cultural exploration, or an adventurous escape? Once youve narrowed down your options, you can move on to the next steps!',
          how3: 'Having a clear budget is crucial. It will guide your choices for accommodation, transportation, and activities. Make sure to include both major expenses (like flights or trains) and smaller ones (like meals and souvenirs). Don’t forget to leave some room for emergencies or unexpected opportunities that may arise during your journey.',
          how4: 'Once your destination and budget are set, it’s time to plan the details. Research the best time to visit, popular landmarks, hidden gems, and local experiences. Create a day-by-day itinerary that balances sightseeing, relaxation, and activities. Don’t forget to leave some free time for spontaneous adventures!',
        },
      },
    },
    ru: {
      translation: {
        ...
        login: {
          ...
          passwordError1: 'Пароль должен содержать не менее 5 символов',
          passwordError2:
            'Пароль должен содержать заглавную и строчную букву, цифру и спецсимвол',
          passwordError3: 'Пароль обязателен',
          confirmPasswordError1: 'Пожалуйста, подтвердите пароль',
          confirmPasswordError2: 'Пароли не совпадают',
        },
        about: {
          workWithUs: 'Работайте с нами',
          title: 'Туристический сайт для вас',
          subTitle1:
            'Откройте для себя захватывающие направления по всему миру.',
          subTitle2: 'Планируйте идеальный отдых легко и уверенно.',
          subTitle3:
            'Эксклюзивные предложения и советы экспертов для каждого путешественника.',
          subTitle4:
            'Ваше путешествие начинается здесь — давайте исследовать вместе.',
          startButton: 'Начать',
          warningVirtual: 'Начните путешествие, не выходя из дома',
          aboutVirtual:
            'Наши виртуальные туры позволяют изучить места онлайн перед поездкой.',
          virtualText1: 'Полный обзор 360° самых известных мест мира.',
          virtualText2:
            'Погрузитесь в атмосферу, культуру и природу прямо с экрана.',
          hlrSearch: 'Умный поиск направлений',
          hlrText:
            'Не знаете куда поехать? Используйте умный поиск для подбора мест по вашему вкусу и бюджету.',
          osnoviApi: 'Интеграция Travel API',
          osnoviApiText:
            'Подключайтесь к авиалиниям, отелям и локальным сервисам с помощью наших мощных API.',
          tochniTitle: 'Точные и актуальные данные',
          tochniText:
            'От обновлений рейсов до погодных условий — вся информация в реальном времени.',
          oxvachen: 'Глобальное покрытие',
          oxvachenText:
            'От мегаполисов до скрытых жемчужин — исследуйте весь мир с нашей платформой.',
        },
        faq: {
          title: 'Часто задаваемые вопросы',
          faqText:
            'Найдите ответы на вопросы по бронированиям, оплатам и путешествиям.',
          sotrudichayte:
            'Хотите сотрудничать? Узнайте, как мы работаем с турагентствами и инфлюенсерами.',
        },
        contactUs: {
          sotrudichayte: 'Давайте сделаем путешествия лучше вместе.',
          name: 'Имя',
          lastName: 'Фамилия',
          support: 'Как мы можем помочь?',
          message: 'Ваше сообщение',
          send: 'Отправить',
          requiredName: 'Пожалуйста, введите имя.',
          requiredLastName: 'Пожалуйста, введите фамилию.',
          requiredMessage: 'Пожалуйста, напишите сообщение перед отправкой.',
          success:
            'Ваше сообщение успешно отправлено! Мы скоро с вами свяжемся.',
        },
        bookComponent: {
          bigTitle: 'Узнайте больше, задав вопрос умному ИИ-инструменту',
          askQuestion: 'Задать вопрос',
          enterText: 'Введите текст',
          askMe: 'Спросите меня о путешествиях...',
        },
        mainAbout: {
          title: 'О нас',
          whyWe: 'Почему мы?',
          howOrder: 'Как заказать путешествие?',
          why1: '1. Экспертиза, которой можно доверять. Мы собрали команду опытных путешественников, местных экспертов и профессионалов отрасли, которые предоставляют вам наиболее точную и актуальную информацию о путешествиях. Мы выходим за пределы обычных туристических гидов, предлагая инсайты от тех, кто действительно знаком с направлениями из первых уст.',
          why2: '2. Индивидуальные планы путешествий. Каждый путешественник уникален, и его потребности тоже. Наша платформа позволяет создать персонализированный маршрут, основываясь на ваших интересах, будь то отдых, приключения, культура или еда. С нашими экспертными рекомендациями вы сможете создать идеальное путешествие, которое подходит вашему стилю и темпу.',
          why3: '3. Беспроблемный процесс бронирования. От бронирования билетов до выбора жилья и планирования мероприятий — наша интегрированная система позволяет делать все в одном месте. Мы сотрудничаем с проверенными поставщиками, чтобы предоставить вам лучшие предложения, экономя время и деньги.',
          why4: '4. Аутентичные местные впечатления. Мы ориентируемся на предоставление рекомендаций, которые помогут вам по-настоящему узнать местную культуру. Будь то скрытые жемчужины, рестораны с местной кухней или необычные достопримечательности, наша цель — помочь вам испытать место как местный житель.',
          how1: 'Планирование путешествия иногда может быть сложным, но с правильным подходом это может стать захватывающим и увлекательным процессом. Независимо от того, куда вы отправляетесь — в дальние края или в исследование ближайших мест, организация путешествия шаг за шагом — это ключ к незабываемому отдыху. Вот как вы можете заказать ваше путешествие от начала до конца.',
          how2: 'Первым шагом является выбор места назначения. Учитывайте такие факторы, как климат, виды деятельности, бюджет и продолжительность путешествия. Хотите пляжный отдых, культурное исследование или приключенческий побег? Как только вы сузите круг выбора, можно переходить к следующим шагам.',
          how3: 'Четко установленный бюджет имеет ключевое значение. Он поможет вам в выборе жилья, транспорта и мероприятий. Обязательно учитывайте как крупные расходы (такие как билеты или поезда), так и более мелкие (еда и сувениры). Не забудьте оставить запас на чрезвычайные ситуации или неожиданные возможности, которые могут возникнуть во время вашего путешествия.',
          how4: 'Когда ваше место назначения и бюджет определены, пора переходить к деталям. Исследуйте лучшее время для посещения, популярные достопримечательности, скрытые жемчужины и местные особенности. Составьте дневной маршрут, который сочетает в себе осмотр достопримечательностей, отдых и активные мероприятия. Не забудьте оставить время для спонтанных приключений!',
        },
      },
    },
    am: {
      translation: {
        ...
        login: {
          ...
          login: 'Մուտք',
          logOut: 'Դուրս գալ',
          haveNotAccaunt: 'Դեռ չունե՞ք հաշիվ։',
          register: 'Գրանցվել',
          phoneNumber: 'Հեռախոսահամար',
          email: 'Էլ․ փոստ',
          confirmPassword: 'Հաստատել գաղտնաբառը',
          pleaseEnterPassword: 'Խնդրում ենք մուտքագրել գաղտնաբառ',
          passwordNotMuch: 'Գաղտնաբառերը չեն համընկնում',
          submit: 'Հաստատել',
          verification: 'Վերահսկում',
          verificationCode: 'Վերահսկման կոդ',
          resetPassword: 'Վերականգնել գաղտնաբառը',
          repeatPassword: 'Կրկնել գաղտնաբառը',
          passwordError1: 'Գաղտնաբառը պետք է առնվազն 5 նիշ լինի',
          passwordError2:
            'Գաղտնաբառը պետք է պարունակի մեծատառ, փոքրատառ, թիվ և հատուկ նշան',
          passwordError3: 'Գաղտնաբառը պարտադիր է',
          confirmPasswordError1: 'Խնդրում ենք հաստատել ձեր գաղտնաբառը',
          confirmPasswordError2: 'Գաղտնաբառերը չեն համընկնում',
        },
        about: {
          workWithUs: 'Աշխատիր մեզ հետ',
          title: 'Ճանապարհորդական կայք Ձեզ համար',
          subTitle1: 'Բացահայտեք հիասքանչ վայրեր ամբողջ աշխարհում։',
          subTitle2:
            'Պլանավորեք ձեր իդեալական հանգիստը հեշտությամբ և վստահությամբ։',
          subTitle3:
            'Բացառիկ առաջարկներ և փորձագետի խորհուրդներ յուրաքանչյուր ճանապարհորդի համար։',
          subTitle4:
            'Ձեր ուղևորությունը սկսվում է այստեղ — եկեք ուսումնասիրենք միասին։',
          startButton: 'Սկսել',
          warningVirtual: 'Սկսեք ձեր ճանապարհորդությունը առանց տունը լքելու',
          aboutVirtual:
            'Մեր վիրտուալ շրջայցերը թույլ են տալիս նախապես ուսումնասիրել գագաթնաժողով վայերերը։',
          virtualText1: 'Ստացեք 360° տեսք հայտնի վայրերից։',
          virtualText2: 'Զգացեք մթնոլորտը, մշակույթը և բնությունը ձեր էկրանից։',
          hlrSearch: 'Խելացի ուղղությունների որոնում',
          hlrText:
            'Չգիտե՞ք ուր գնալ։ Մեր խելացի որոնումը կօգնի գտնել տեղեր ձեր նախասիրությամբ և բյուջեով։',
          osnoviApi: 'Ճանապարհորդական API ինտեգրում',
          osnoviApiText:
            'Միացեք ավիաընկերություններին, հյուրանոցներին և տեղական փորձառություններին մեր հզոր API-ներով։',
          tochniTitle: 'Ճշգրիտ և իրական ժամանակի տվյալներ',
          tochniText:
            'Թռիչքների նորացումներից մինչև եղանակի պայմաններ — ամեն ինչ՝ ըստ իրական ժամանակի։',
          oxvachen: 'Համաշխարհային ծածկույթ',
          oxvachenText:
            'Մայրաքաղաքներից մինչև թաքնված գոհարներ — ուսումնասիրեք ամբողջ աշխարհը։',
        },
        faq: {
          title: 'Հաճախ տրվող հարցեր',
          faqText:
            'Գտեք պատասխաններ ամրագրումների, վճարումների և ճանապարհորդության վերաբերյալ հարցերին։',
          sotrudichayte:
            'Ցանկանու՞մ եք համագործակցել։ Իմացեք, թե ինչպես ենք աշխատում տուրիստական գործակալությունների և ինֆլուենսերների հետ։',
        },
        contactUs: {
          sotrudichayte: 'Եկեք միասին դարձնենք ճանապարհորդությունը ավելի լավը։',
          name: 'Անուն',
          lastName: 'Ազգանուն',
          support: 'Ինչպե՞ս կարող ենք օգնել։',
          message: 'Ձեր հաղորդագրությունը',
          send: 'Ուղարկել',
          requiredName: 'Խնդրում ենք մուտքագրել անունը։',
          requiredLastName: 'Խնդրում ենք մուտքագրել ազգանունը։',
          requiredMessage: 'Նախքան ուղարկելը գրեք հաղորդագրություն։',
          success:
            'Ձեր հաղորդագրությունը հաջողությամբ ուղարկվել է։ Մենք կկապվենք ձեզ հետ շուտով։',
        },
        bookComponent: {
          bigTitle: 'Իմացեք ավելին՝ հարց տալով խելացի AI գործիքին',
          askQuestion: 'Տալ հարց',
          enterText: 'Մուտքագրեք տեքստը',
          askMe: 'Հարցրու ինձ ամեն ինչ ճանապարհորդությունների մասին...',
        },
        mainAbout: {
          title: 'Մեր մասին',
          whyWe: 'Ինչու մենք?',
          howOrder: 'Ինչպես պատվիրել ճանապարհորդություն?',
          why1: '1. Մասնագիտական վստահություն. Մենք հավաքել ենք փորձառու ճանապարհորդների, տեղական փորձագետների և ոլորտի մասնագետների թիմ, որոնք ձեզ տրամադրում են ամենալավ, ժամանակակից ճանապարհորդական տեղեկություններ: Մենք դուրս ենք գալիս սովորական զբոսաշրջային գիդերից, տրամադրելով այնպիսի տեղեկություններ, որոնք ստացել են նրանք, ովքեր իրականում եղել են այդ վայրերում:',
          why2: '2. Տարօրինակ ճանապարհորդական պլաններ. Յուրաքանչյուր ճանապարհորդ յուրահատուկ է, և նրանց պահանջները նույնպես: Մեր հարթակը թույլ է տալիս ստեղծել հարմարեցված ծրագիր ձեր հետաքրքրությունների հիման վրա, լինի դա հանգստություն, արկածախնդրություն, մշակույթ կամ սնունդ: Մեր մասնագիտական խորհուրդներով դուք կկարողանաք կազմել կատարյալ ճանապարհորդություն, որը կհամապատասխանի ձեր ոճին ու տեմպին:',
          why3: '3. Առանց դժվարությունների ամրագրում: Թռիչքների ամրագրումից մինչև բնակարանների ապահովում և գործողություններ պլանավորելը, մեր ինտեգրված համակարգը թույլ է տալիս անել դա բոլորը մեկ տեղում: Մենք համագործակցում ենք վստահելի մատակարարների հետ, որպեսզի դուք ունենաք լավագույն առաջարկությունները, խնայելով ժամանակ և գումար:',
          why4: '4. Ավտենտիկ տեղական փորձառություններ. Մենք կենտրոնանում ենք այնպիսի խորհուրդներ տրամադրելու վրա, որոնք կտան ձեզ իրական պատկեր տեղական մշակույթից: Պահպանելով գաղտնի վայրերը, տեղական ռեստորանները կամ անորոշ գրավչությունները բացահայտելը, մեր նպատակն է ձեզ օգնել ապրելու ուղղություններ տեղական եղանակով:',
          how1: 'Փնտրելու ճանապարհորդություննsometimes կարող է լինել բարդ, սակայն ճիշտ մոտեցման դեպքում կարող է լինել հուզիչ և առանց դժվարությունների պրոցես: Կախված այն բանից, թե որտեղ եք գնում, կազմակերպման քայլերի կիրառումը անհրաժեշտ է անցնելու ձեր ճանապարհորդությունը հիանալի ժամանակի համար: Ահա թե ինչպես դուք կարող եք կազմակերպել ձեր ճանապարհորդությունը հենց սկզբից:',
          how2: 'Առաջին քայլը նպատակակետ ընտրելն է»։ Հաշվի առեք այնպիսի գործոններ, ինչպիսիք են կլիման, գործունեությունը, բյուջեն և ուղևորության տևողությունը։ Փնտրու՞մ եք ծովափնյա արձակուրդ, մշակութային ուսումնասիրություն կամ արկածային փախուստ։ Երբ նեղացնեք ձեր ընտրության շրջանակը, կարող եք անցնել հաջորդ քայլերին։',
          how3: ' «Հստակ սահմանված բյուջեն գլխավորն է»։ Նա կօգնի ձեզ կացարանի, տրանսպորտի և ժամանցի ընտրության հարցում։ Համոզվեք, որ հաշվի եք առել ինչպես մեծ ծախսերը (օրինակ՝ տոմսեր կամ գնացքներ), այնպես էլ փոքրերը (սնունդ և հուշանվերներ): Համոզվեք, որ որոշակի պաշարներ եք թողել արտակարգ իրավիճակների կամ անսպասելի իրադարձությունների համար, որոնք կարող են առաջանալ ձեր ուղևորության ընթացքում։',
          how4: '«Երբ ձեր ուղղությունը և բյուջեն որոշված ​​լինեն, ժամանակն է անցնել մանրամասներին»։ Ուսումնասիրեք այցելելու լավագույն ժամանակը, հայտնի տեսարժան վայրերը, թաքնված գանձերը և տեղական առանձնահատկությունները։ Ստեղծեք ցերեկային երթուղի, որը համատեղում է տեսարժան վայրերի դիտումը, հանգիստը և ակտիվ գործունեությունը։ Մի՛ մոռացեք ժամանակ հատկացնել ինքնաբուխ արկածների համար։',
        },
      },
    },
  },
